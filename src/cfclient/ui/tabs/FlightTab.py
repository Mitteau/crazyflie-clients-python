...
class FlightTab(Tab, flight_tab_class):
    ...
    def __init__(self, tabWidget, helper, *args):
        ...
        self.helper.inputDeviceReader.assisted_set_local(False)
    ...
    def set_cf_assist(self, value) :
        if not self.inhibit :
            if value :
                ...
                s = "0"
                self._bascule = False
            self.checkAssisted.setChecked(False)
            try :
...
#### pas de cas poshold
        ...
        try:
            ...
            if assistmodeComboIndex == 2 and not heightHoldPossible:
                assistmodeComboIndex = 0
            if assistmodeComboIndex == 0 and heightHoldPossible:
                assistmodeComboIndex = 2
            if assistmodeComboIndex == 0 and hoverPossible:
